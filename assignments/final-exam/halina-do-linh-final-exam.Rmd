...
rprice = beta0 + beta1 treatment group & time + treatment group + post treatment period (1981) + errors
...
DD_inc1 <- lm(data = incinerator_data,
              formula = rprice ~ as.factor(nearinc) + )
